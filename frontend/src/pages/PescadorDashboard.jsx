  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-950 via-indigo-900 to-sky-900 text-white">
      ...
      <div className="p-8 space-y-10">
        <h1 className="text-4xl font-bold text-center">Panel del Pescador 🎣</h1>
              ...
              {lotes.map((l) => (
                <tr key={l.id}>
                  ...
                  <td>
                    {l.estado === "en crianza" ? (
                      <button
                        onClick={() => updateEstado(l.id, "en venta")}
        ...
        {/* CREAR PROVEEDOR */}
        <section className="bg-blue-900/50 p-6 rounded-xl shadow-lg max-w-xl mx-auto">
          ...
          <form onSubmit={createProveedor} className="space-y-3">
            ...
            <button className="bg-green-600 w-full p-2 rounded hover:bg-green-700">
              Crear Proveedor
            </button>
          </form>
        </section>
...
export default PescadorDashboard;
